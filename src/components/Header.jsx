  ...
  return (
    <header className="h-14 bg-white border-b border-slate-200 px-5 flex items-center justify-between sticky top-0 z-30 shadow-card">
      ...
      <div className="flex items-center space-x-2 ml-4">
        ...
        {/* SIH badge */}
        <div className="hidden xl:flex items-center space-x-1 px-2.5 py-1.5 rounded-md bg-saffron-50 border border-saffron-200 text-[11px] text-saffron-700 font-semibold">
