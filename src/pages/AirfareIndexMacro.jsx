        ...
        <div className="h-[260px] mt-4">
          <ResponsiveContainer width="100%" height="100%">
            <LineChart data={macroData}>
              ...
              <XAxis dataKey="date" stroke="#66748F" tick={{ fontSize:10, fill:'#66748F' }} tickLine={false} />
              <YAxis domain={[90,135]} stroke="#66748F" tick={{ fontSize:10, fill:'#66748F' }} tickLine={false} />
