...
export const RouteAnalysis = ({ initialRoute = 'DEL-BOM' }) => {
  ...
  const dispersion = [
    { carrier:'IndiGo (6E)',   flights:35, min:4199, mean:5400, max:8200,  share:52, color:'#1F4FBF' },
          ...
          <div className="h-[260px] mt-4">
            <ResponsiveContainer width="100%" height="100%">
              <LineChart data={evolutionData}>
                ...
                <XAxis dataKey="day" stroke="#66748F" tick={{ fontSize:10, fill:'#66748F' }} tickLine={false} />
                <YAxis domain={[3500,13000]} stroke="#66748F" tick={{ fontSize:10, fill:'#66748F' }} tickLine={false} tickFormatter={v=>`₹${v}`} />
                <Tooltip content={<LightTooltip />} />
                <Line type="monotone" dataKey="observed" name="Observed" stroke="#1F4FBF" strokeWidth={2.5} dot={{ r:4, fill:'#1F4FBF' }} connectNulls={false} />
